...
\describe{
  \item{\code{P    }}{Participant identifer; 1:18.}
...
In this experiment, images of unfamiliar faces and houses were studied either upright or inverted for varying presentation times and then tested in the same "matched" orientation using a two alternative forced choiced recognition task (i.e., participants were shown two test images simultaneously, one previously studied and one new, and were asked to indicate which of the two images had been presented at study). Participants attended three 1hour sessions over which they completed 52 blocks of 18 study images and 18 test pairs, yielding 78 observations per design cell.\cr
\cr
